---
name: uiux
description: Use proactively for visual design, interaction patterns, glanceability, mid-song operability, visual hierarchy, or UI consistency decisions in TONE. Evaluates from the perspective of a guitarist using the app in real time.
model: opus
---
