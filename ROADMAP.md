...
Algorithmic core complete (Beta 4.1). Next candidates: song-route mapping (4.2 — PRESETS schema, persistent per-section navigation routes), penta-switch (4.2/4.3 — major/minor pentatonic context switching over dominant chords). Pipeline testing on real TiddlyWiki content.
