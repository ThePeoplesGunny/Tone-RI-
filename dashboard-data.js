...
const AGENT_DASHBOARD = {
  ...
  dimensions: [
    { label: 'Blues foundation respected',
      target: 10, scores: { hendrix: 9, evh: 8, srv: 9 },
    ...
    { label: 'Chord-tone targeting',
      target: 10, scores: { hendrix: 9, evh: 9, srv: 10 },
