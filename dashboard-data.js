...
const AGENT_DASHBOARD = {
  ...
  dimensions: [
    { label: 'Blues foundation respected',
      ...
      projected: 'At ceiling. Penta-switch resolved (4.3).',
    },
    ...
    { label: 'Chord-tone targeting',
      target: 10, scores: { hendrix: 10, evh: 10, srv: 10 },
      ...
      projected: 'At ceiling. Song routes resolved (4.2).',
    },
    { label: 'Rhythm / lead integration',
      target: 8, scores: { hendrix: 7, evh: 6, srv: 9 },
    ...
    { label: 'Zoom spectrum accuracy',
      target: 10, scores: { hendrix: 8, evh: 7, srv: 9 },
