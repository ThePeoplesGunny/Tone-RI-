...
const GEAR_INVENTORY = {
  ...
  drives: [
    ...
    },
    {
      ...
      stackable: true,
      notes: 'Two independent sides; either or both can be engaged. Heavy Hand stacks well after TS808 for solo lift (KWS recipe).',
    },
    {
  ...
  timeBased: [
    ...
    },
    {
      ...
      name: 'TC Electronic Flashback Delay and Looper',
      shortName: 'Flashback',
      type: 'delay',
  ...
  wahs: [
    {
      ...
      switches: [
        ...
        { id: 'boost',        type: 'two-position', positions: ['off', 'on (+15dB)'] },
      ],
    ...
    },
    {
      ...
      typicalDeployment: 'studio-tier wah; voicing switch covers wide territory. More refined than standard Cry Baby family.',
    },
    {
      id: 'vox-v847a',
  ...
  utility: [
    ...
    },
    {
      ...
      roles: ['power-supply'],
      notes: 'Powers the pedalboard. Not in signal chain.',
    },
  ],
